...
##
## It parses the YAML sections of kernels/devices.yml and creates:
...
##
## E.g.:
##   $ ./generate-release.py -i ../kernels/devices.yml -o /media/kali/NetHunter/images -r 2024.3
##
## Dependencies:
...
def bail(message = "", strerror = ""):
    ...
    if strerror != "":
        ...
        outstr += "\nE.g. : {} -i kernels/devices.yml -o images -r {}.1\n".format(prog, datetime.datetime.now().year)
    print(outstr)
    sys.exit(2)
